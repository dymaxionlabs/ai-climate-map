...
export const locations = [
  {
    ...
    layers: [
      ...
      },
      {
        group: "l4",
        name: "Global",
        path: "/l4/tegu/l4_tegu_global_bg_rgb.tif",
        legend: "l4",
        category: "global",
      },
      {
        group: "l4",
        name: "Local",
        path: "/l4/tegu/l4_tegu_local_bg_rgb.tif",
        legend: "l4",
        category: "local",
      },
    ],
  },
  {
    ...
    layers: [
      ...
      },
      {
        group: "l4",
        name: "Global - Extreme",
        path: "/l4/sula/l4_sula_global_extremo_bg_rgb.tif",
        legend: "l4",
        category: "global",
      },
      {
        group: "l4",
        name: "Global - Moderate",
        path: "/l4/sula/l4_sula_global_moderado_bg_rgb.tif",
        legend: "l4",
        category: "global",
      },
      {
        group: "l4",
        name: "Local - Extreme",
        path: "/l4/sula/l4_sula_local_extremo_bg_rgb.tif",
        legend: "l4",
        category: "local",
      },
      {
        group: "l4",
        name: "Local - Moderate",
        path: "/l4/sula/l4_sula_local_moderado_bg_rgb.tif",
        legend: "l4",
        category: "local",
      },
    ],
